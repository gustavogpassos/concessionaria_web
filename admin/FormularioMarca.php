...
if (!adminEstaLogado()) {
    ...
    <h1>Dados do Cadastro de Marcas</h1>
    <form action="CadastraMarca.php" method="Post">
        <table class="table">
            <tr>
                <td>Nome:</td>
                <td><input class="form-control" type="texto" name="nomemarca" required="required" value="" > </td>
            </tr>
            <tr>
