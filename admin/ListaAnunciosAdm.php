...
<h1>Lista de Anúncios Ativos</h1>

<table class="table table-striped table-bordered">
        <tr>
            <td>
                <form action="ListaAnunciosAdm.php" method="Post">
                    Filtrar:
            ...
            <td>
                <a class="btn btn-primary" href="ListaAnunciosDesat.php">Anúncios Desativados</a>
            </td>
...
<table class="table table-striped table-bordered">
    ...
    <?php
    $anuncios = listaAnunciosAtivos($conexao, $filtro, $ordem);
    foreach( $anuncios as $anuncio ){
    ?>    
        <tr>          
            <td><imagem><img src="imagemAnuncios/<?= $anuncio['imagem'] ?>" alt="Imagem" height="80" width="100"></imagem></td> 
            <td> <?= $anuncio['nome'] ?> </td>
            ...
            <td>
                <form action="DesativaAnuncio.php" method="Post">
                    <input type="hidden" name="id" value="<?= $anuncio['id'] ?>">
                    <button class="btn btn-danger">Destivar</button>
                </form>
            </td>
        </tr>
    <?php    
